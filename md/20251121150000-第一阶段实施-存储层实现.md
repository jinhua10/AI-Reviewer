...
**创建时间**: 2025-11-21 15:00:00  
**阶段**: 第一阶段 (第1-2周)  
**负责模块**: local-file-rag-core/storage  
**状态**: 进行中
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <description>本地文件存储RAG替代框架</description>
...
**文件**: `local-file-rag-core/pom.xml`
...
**文件路径**: `local-file-rag-core/src/main/java/com/framework/core/model/Document.java`
...
**文件路径**: `local-file-rag-core/src/main/java/com/framework/core/storage/StorageEngine.java`
...
**文件路径**: `local-file-rag-core/src/main/java/com/framework/core/storage/DocumentHasher.java`
...
**文件路径**: `local-file-rag-core/src/main/java/com/framework/core/storage/impl/FileSystemStorageEngine.java`
...
**文件路径**: `local-file-rag-core/src/main/java/com/framework/core/storage/impl/SHA256DocumentHasher.java`
...
**文件路径**: `local-file-rag-core/src/main/java/com/framework/core/storage/impl/MetadataManager.java`
...
**文件路径**: `local-file-rag-core/src/main/java/com/framework/core/storage/impl/SQLiteMetadataManager.java`
...
**文件路径**: `local-file-rag-core/src/test/java/com/framework/core/storage/FileSystemStorageEngineTest.java`
...
class FileSystemStorageEngineTest {
    ...
    void testStoreAndRetrieve() {
        ...
        assertEquals("这是测试内容", retrieved.get().getContent());
        assertEquals("测试文档", retrieved.get().getTitle());
    }
    ...
    void testCount() {
        ...
        storageEngine.store(Document.builder().content("文档1").build());
        storageEngine.store(Document.builder().content("文档2").build());
...
**文件路径**: `local-file-rag-core/src/main/resources/logback.xml`

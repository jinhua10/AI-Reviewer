package top.yumbo.ai.refactor.integration.endtoend;
...
class CommandLineEndToEndTest {
    ...
    class SmallProjectAnalysisTest {
        ...
        void shouldGenerateCompleteAnalysisReport() {
            ...
            var project = top.yumbo.ai.refactor.domain.model.Project.builder()
                    .name("small-java-project")
                    .rootPath(javaProject)
                    .type(top.yumbo.ai.refactor.domain.model.ProjectType.JAVA)
                    .sourceFiles(files)
                    .build();
    ...
    class MediumProjectAnalysisTest {
        ...
        void shouldHandleAsyncAnalysisFlow() throws InterruptedException {
            ...
            var project = top.yumbo.ai.refactor.domain.model.Project.builder()
                    ...
                    .type(top.yumbo.ai.refactor.domain.model.ProjectType.PYTHON)
                    .sourceFiles(files)
                    .build();
    ...
    class ErrorScenarioTest {
        ...
        void shouldCancelRunningTask() {
            ...
            var proj = top.yumbo.ai.refactor.domain.model.Project.builder()
                    .name("test-project")
                    .rootPath(project)
                    .type(top.yumbo.ai.refactor.domain.model.ProjectType.JAVA)
                    .sourceFiles(files)
